...
@IonicPage()
@Component({
  selector: 'page-security-incident',
  templateUrl: 'security-incident.html',
})
export class SecurityIncidentPage implements OnInit{
  ...
  public category:any = "Security Incident";
...

  {
    ...
    this.formName = "Security Incident";
  ...
  selectSubmission(id){
    ...
    this.DB.retrieveSubmission(id)
        .then((doc)=>{
          ...
          this.reportedToPolice = doc[0].ReportedToPolice;
          this.policeForce = doc[0].PoliceForce;
          this.itemOwnership = doc[0].ItemOwnership;
          this.smartWaterSite = doc[0].SmartWaterSite;
          this.seriousInjuryOrFatality = doc[0].SeriousInjuryOrFatality;
          this.estimateValueOfLossDamage = doc[0].EstimateValueOfLossDamage;
          this.itemDescription = doc[0].ItemDescription;
          this.policeCrimeRefNo = doc[0].PoliceCrimeRefNo;
          this.tickDateAndTime = doc[0].tickDateAndTime

          this.TimeIncidentHappened = doc[0].TimeIncidentHappened;
          this.DateOfIncident = doc[0].DateOfIncident;
  ...
  saveSubmission($event, showType = ""){
    ...
    form_result['ReportedToPolice'] = this.form.controls.whatHappened.get("reportedToPolice").value?this.form.controls.whatHappened.get("reportedToPolice").value:'';
    form_result['PoliceForce'] = this.form.controls.whatHappened.get("policeForce").value?this.form.controls.whatHappened.get("policeForce").value:'';
    form_result['ItemOwnership'] = this.form.controls.whatHappened.get("itemOwnership").value?this.form.controls.whatHappened.get("itemOwnership").value:'';
    // form_result['SeriousInjuryOrFatality'] = this.form.controls.whatHappened.get("seriousInjuryOrFatality").value?this.form.controls.whatHappened.get("seriousInjuryOrFatality").value:'';
    form_result['EstimateValueOfLossDamage'] = this.form.controls.whatHappened.get("estimateValueOfLossDamage").value?this.form.controls.whatHappened.get("estimateValueOfLossDamage").value:'';
    form_result['ItemDescription'] = this.form.controls.whatHappened.get("itemDescription").value?this.form.controls.whatHappened.get("itemDescription").value:'';
    form_result['PoliceCrimeRefNo'] = this.form.controls.whatHappened.get("policeCrimeRefNo").value?this.form.controls.whatHappened.get("policeCrimeRefNo").value:'';


    form_result['SmartWaterSite'] = this.form.controls.whereAndWhen.get("smartWaterSite").value?this.form.controls.whereAndWhen.get("smartWaterSite").value:'';
    form_result['TickDateAndTime'] = this.form.controls.whereAndWhen.get("tickDateAndTime").value?this.form.controls.whereAndWhen.get("tickDateAndTime").value:'';
    form_result['TimeIncidentHappened'] = this.form.controls.whereAndWhen.get("time").value?this.form.controls.whereAndWhen.get("time").value:'';
    form_result['DateOfIncident'] = this.form.controls.whereAndWhen.get("date").value?this.form.controls.whereAndWhen.get("date").value:'';
    ...
    // new record
      ...
      this.DB.addSubmission(category, form_result, this.isSaveSubmit).then((data) =>{
        console.log("Security Incident: "+ data);
        this.hideForm = true;
  ...
  initForm(){
    ...
    this.form = this.fb.group({
      ...
      whereAndWhen: this.fb.group({
        ...
        dateOfIncident: [{value: this.DateOfIncident, disabled: false}],
        timeIncidentHappened: [{value: this.TimeIncidentHappened, disabled: false}],
        tickDateAndTime:this.tickDateAndTime,
      }),
