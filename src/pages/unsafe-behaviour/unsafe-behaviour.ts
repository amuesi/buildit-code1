...
@IonicPage()
@Component({
  selector: 'page-unsafe-behaviour',
  templateUrl: 'unsafe-behaviour.html',
})
export class UnsafeBehaviourPage implements OnInit{
  ...
  public category:any = "Unsafe Behaviour";
...

  {
    ...
    // this.ev.subscribe('autosave_unsafe_behaviour', data => {
  ...
  ionViewWillLeave() {
    this.ev.unsubscribe('autosave_unsafe_behaviour');
  }
  ...
  selectSubmission(id){
    ...
    this.DB.retrieveSubmission(id)
        .then((doc)=>{
          ...
          this.didYouSpeakToPerson = doc[0].DidYouSpeakToPerson;
  ...
  saveSubmission($event, showType = ""){
    ...
    form_result['IncidentDescription'] = this.form.controls.whatHappenedUnsafeBehaviour.get("incidentDescription").value?this.form.controls.whatHappenedUnsafeBehaviour.get("incidentDescription").value:'';
    ...
    form_result['DidYouSpeakToPerson'] = this.form.controls.immediateCorrectiveAction.get("didYouSpeakToPerson").value?this.form.controls.immediateCorrectiveAction.get("didYouSpeakToPerson").value:'';
  ...
  initForm(){
    ...
    this.form = this.fb.group({
      ...
      whatHappenedUnsafeBehaviour:this.fb.group({
        incidentDescription:[{value: this.incidentDescription, disabled: false}],
      ...
      whereAndWhen: this.fb.group({
        ...
        immediateCorrectiveAction: this.fb.group({
          didYouSpeakToPerson: [{value: this.didYouSpeakToPerson, disabled: false}],
          correctiveActionTakenControl: this.actionTaken,  // this.actionTaken,
      ...
      furtherInformation: this.fb.group({
        consideredTheFollowing:[{value: this.consideredTheFollowing, disabled: false}],  // this.consideredTheFollowing
      })
