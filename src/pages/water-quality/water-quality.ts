...
export class WaterQualityPage implements OnInit{
  ...
  public category:any = "WaterQuality";
...
//  ActionsRequired: any;
...

  {
    ...
    if (this.TimeOfOccurence == null){
      let st_date = new Date().getHours();
      var date = st_date.toString();
      var st_time = new Date().getMinutes();
  ...
  ionViewWillLeave() {
    this.ev.unsubscribe('autosave_waterquality');
  }
  ...
  ionViewDidLoad() {
    ...
    console.log('ionViewDidLoad WaterQualityPage');
  }
  ...
  saveSubmission($event, showType = ""){
    ...
    // form_result['ActionRequired'] = this.form.controls.immediateCorrectiveAction.get("actionsRequired").value;
	  ...
	  form_result['RemovedHazard'] = this.form.controls.furtherInformation.get("removedHazard").value ? this.form.controls.furtherInformation.get("removedHazard").value: '';



    form_result['standards'] = this.form.controls.immediateCorrectiveAction.get("consideredTheFollowing").value ? this.form.controls.immediateCorrectiveAction.get("consideredTheFollowing").value: '';
  ...
  initForm(){
    ...
    this.form = this.fb.group({
      ...
      immediateCorrectiveAction: this.fb.group({
        ...
        removedHazard:[{value: this.removedHazard, disabled: false}],
