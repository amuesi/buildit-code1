...
@IonicPage()
@Component({
  selector: 'page-security-non-compliance',
  templateUrl: 'security-non-compliance.html',
})
export class SecurityNonCompliancePage implements OnInit{
  ...
  public category:any = "Security Non Compliance";
...

  {
    ...
    this.formName = "Security Non Compliance";
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SecurityNonCompliancePage');
  }
  ...
  saveSubmission($event, showType = ""){
    ...
    // new record
      ...
      this.DB.addSubmission(category, form_result, this.isSaveSubmit).then((data) =>{
        console.log("Security Non Compliciance: "+ data);
        this.hideForm = true;
