...
@Component({
  selector: 'where-and-when-unsafebehaviour',
  templateUrl: 'where-and-when-unsafebehaviour.html'
})
export class WhereAndWhenUnsafeBehaviourComponent implements OnInit {
