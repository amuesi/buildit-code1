...
@Component({
  selector: 'where-and-when-security-non-compliance',
  templateUrl: 'where-and-when-security-non-compliance.html'
})
export class WhereAndWhenSecurityNonComplianceComponent implements OnInit {
