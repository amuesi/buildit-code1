...
@Component({
  selector: 'where-and-when-hazard-security-incident',
  templateUrl: 'where-and-when-hazard-security-incident.html'
})
export class WhereAndWhenHazardSecurityIncidentComponent implements OnInit {
  ...
  public tickDateAndTime: boolean = false;
  ...
  public DateOfIncident: any;
  public TimeIncidentHappened: any;
  public selectedDateAndTime: any = false;
  ...
  TickDateAndTime($event){
        this.selectedDateAndTime = true;
  }
  ...
  async formInit(){
    ...
    await this.appDataProvider.getsmartWaterSite()
    .subscribe(category =>{
      this.smartWaterSite = category;
      console.dir('smartWaterSite=', this.smartWaterSite);
    });
    // try {
