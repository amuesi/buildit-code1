...
@Component({
  selector: 'where-and-when-security-good-practice',
  templateUrl: 'where-and-when-security-good-practice.html'
})
export class WhereAndWhenSecurityGoodPracticeComponent implements OnInit {
